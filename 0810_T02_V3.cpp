...
int main(){
    ...
    while(true){
        ...
        if(detalhe>=4){
            ...
            // menu de escolha para nova encomenda ou alterar a atual 
            gotoxy(0,15);cout<<"1-Nova Encomenda";
            gotoxy(0,16);cout<<"2-Alterar Atual(quantidade)";
            gotoxy(0,17);cout<<"3-Guardar Encomenda";
            gotoxy(0,18);cout<<"4-Terminar o programa.";
            gotoxy(0,20);cout<<"Digite a sua opção:";
            cin>>opcao;
            switch(opcao){
                case 1:
                    layout();
                    break;
                case 4:    
                    gotoxy(0,22);cout<<"Fim do programa.";
                    exit(0);
            }
...
void layout(){
    ...
    total=0;linha=5;detalhe=0,opcao=0;
    existe=false;
